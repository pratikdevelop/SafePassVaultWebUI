  ...
  planTypes = [
    ...
    },
    {
      ...
      features: [
        ...
        { icon: '🔒', text: 'MFA: TOTP, SMS, Email, Duo, Fingerprint, Face Recognition, Security Keys' }
      ],
      buttonLink: "/auth/signup",
      buttonText: 'Get Started'
    },
    ...
    },
    {
      ...
      features: [
        ...
        { icon: '🔒', text: 'MFA: TOTP, SMS, Email, Duo, Fingerprint, Face Recognition, Security Keys, Behavioral Biometrics, QR Code, Magic Link' }
      ],
      buttonLink: "/auth/signup",
      buttonText: 'Start a Trial'
    }
