...
@Component({
  ...
  standalone: true,
  imports: [MatButtonModule, MatDialogModule, CommonModule, MatInputModule, MatFormFieldModule, ReactiveFormsModule, FormsModule, MatCardModule, MatDialogModule, MatToolbarModule, MatChipsModule, MatIconModule, MatChipListbox, MatExpansionModule],
